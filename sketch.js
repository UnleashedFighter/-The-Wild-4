...
if(frameCount%180 === 0 && gameState!= "END"){
apple = createSprite(700,500,50,50)
apple.x = Math.round(random(50,1800))
apple.y = Math.round(random(50,800))
apple.addImage("appleImage", appleImage)
apple.scale = 0.25
apple.lifetime = 400
apple.depth = lion.depth
